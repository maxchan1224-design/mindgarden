...
import { PERSONA_META, uid, type PersonaId, type Profile, type ResponseMode } from '../domain';
...
export default function Settings({ profile, onSwitch }: { profile: Profile; onSwitch: () => void }) {
  ...
  async function addProfile() {
    ...
    if (!name) return;
    const p: Profile = { id: uid(), name, personaId: 'aqing', responseMode: 'ask', createdAt: Date.now() };
